...
@Component({
  selector: 'app-dynamic-knob',
  standalone: true,
  templateUrl: './dynamic-knob.html',
  styleUrls: ['./dynamic-knob.scss']
})

export class DynamicKnobComponent {
  ...
  sensitivity = input<number>(0.002); // pixels per unit
